...
Evidence for replacing Leaf as the templating engine. These are known structural problems, not bugs to fix — they inform the Leaf replacement evaluation in `qa-backlog.md`.
