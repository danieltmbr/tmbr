document.addEventListener('DOMContentLoaded', () => {
    ...
    const storageKey = itemID ? `editor:album:${itemID}` : 'editor:album:new';
    ...
    const lookup = new LookupController({ endpoint: '/albums/lookup', excludeID: parseInt(idInput?.value) || null });
