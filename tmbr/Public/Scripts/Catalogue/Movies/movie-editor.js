document.addEventListener('DOMContentLoaded', () => {
    ...
    const directorInput       = document.getElementById('editor-director');
    ...
    const lookup = new LookupController({ endpoint: '/movies/lookup', excludeID: parseInt(idInput?.value) || null });
    ...
    function setState(state) {
        ...
        if (typeof state.director === 'string' && !directorInput.value) directorInput.value = state.director;
    ...
    function applyMetadata(data) {
        ...
        if (!directorInput.value && data.director) directorInput.value = data.director;
    ...
    directorInput?.addEventListener('input', saveDraft);
